...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>R Fajri N Portofolio</title>
      ...
      <main className=" bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className=" min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className=" text-xl font-burtons dark:text-white">rfajrin</h1>
          ...
          <div className=" text-center p-10 ">
            ...
            <div className=" relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-60 h-60 mt-20 overflow-hidden md:h-96 md:w-96">
              <Image src={rfajrin} layout="fill" objectFit="cover" />
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 flex">
              <Image src={web1} className="rounded-lg object-cover " layout="responsive" width={"100%"} height={"100%"} />
            </div>
            <div className="basis-1/3 flex-1 flex ">
              <Image src={web2} className="rounded-lg object-cover " layout="responsive" width={"100%"} height={"100%"} />
            </div>
            <div className="basis-1/3 flex-1 flex ">
              <Image src={web3} className="rounded-lg object-cover " layout="responsive" width={"100%"} height={"100%"} />
            </div>
            <div className="basis-1/3 flex-1 flex">
              <Image src={web4} className="rounded-lg object-cover " layout="responsive" width={"100%"} height={"100%"} />
            </div>
            <div className="basis-1/3 flex-1 flex">
              <Image src={web5} className="rounded-lg object-cover " layout="responsive" width={"100%"} height={"100%"} />
            </div>
            <div className="basis-1/3 flex-1 flex">
              <Image src={web6} className="rounded-lg object-cover " layout="responsive" width={"100%"} height={"100%"} />
            </div>
          </div>
        </section>
      </main>
